...
"  $($files.Count) files. Key ones: " + (($names | Where-Object { $_ -match 'quad_views_foveated\.dll|OBSMirror\.(dll|json)|openxr-api-layer\.json|win-openxr\.dll|^GazeMirror\.(exe|dll)$' }) -join ', ')
'--- Shortcuts'
