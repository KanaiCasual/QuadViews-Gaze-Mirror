...
public sealed class QuadViewsFile
{
    ...
    public const string AddedMarker = "# Added by OpenXR Gaze Overlay: set here, above the headset sections, so they apply under every OpenXR runtime.";
    ...
    public static QuadViewsFile Load(string path)
    {
        ...
        return new QuadViewsFile
        {
            Lines =
            [
                "# Quad-Views-Foveated settings, written by OpenXR Gaze Overlay.",
